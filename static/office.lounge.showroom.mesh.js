/* office.lounge.showroom.mesh.js — prototype bar and office-lounge placeables. */
...
function barCounter(ctx) {
  const parts = [
    ...
    part(ctx, 'countertop', at(ctx.tileBox(3.08, 0.98, 0.14, 'honey-wood'), 0, 0.99, 0)),
  ...
  return finish(ctx, 'bar-counter', 3.1, 1.0, parts);
}
...
function backBar(ctx) {
  ...
  return finish(ctx, 'back-bar', 2.35, 0.62, parts);
}
...
function beerKeg(ctx) {
  ...
  return finish(ctx, 'beer-keg', 0.82, 0.82, parts);
}
...
function draftTower(ctx) {
  ...
  return finish(ctx, 'draft-tower', 1.4, 0.85, parts);
}
...
function barStool(ctx) {
  ...
  return finish(ctx, 'bar-stool', 0.85, 0.85, parts);
}
...
function television(ctx) {
  ...
  return finish(ctx, 'television', 3.2, 0.82, parts);
}
